...
public interface BankSoalService {
    ...
    ResponseWithMessageAndData<BankSoalDto> updateBankSoal(String idBankSoal, BankSoalEditRequest bankSoalEditRequest);
    ResponseWithMessage deleteBankSoal(String idBankSoal);
}
